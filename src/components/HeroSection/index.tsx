...
import profilePhoto from '@/assets/images/foto.jpeg';
    ...
    return (
        <section className="section-full">
            <div className="w-40 h-40 sm:w-52 sm:h-52 relative rounded-full border-4 border-purple-900">
                <Image src={profilePhoto} alt="selfie" className="rounded-full" quality={100} fill />
            </div>
            ...
            <div className="my-6 space-y-2 sm:my-8 sm:space-y-4">
                <TypeAnimation
                    ...
                    speed={50}
                    className="text-5xl sm:text-8xl text-purple-900 text-center font-black"
                    repeat={Infinity}
                    wrapper="h1"
