        ...
        <section className="section-full">
            ...
            <div className="w-full grid grid-cols-[repeat(2,5rem)] grid-rows-5 gap-12 my-6 justify-items-center justify-around lg:grid-cols-[repeat(5,5rem)] lg:grid-rows-2 lg:gap-20 lg:my-8 lg:justify-between">
                <div className="shadow-md p-4 rounded-md flex flex-wrap justify-center items-center w-full h-full dark:bg-zinc-800">
                    <Image
                        src="/icons/stack/react-icon.png"
                        alt="react-icon"
                        width={0}
                        height={0}
                        sizes="100vw"
                ...
                <div className="shadow-md p-4 rounded-md flex flex-wrap justify-center items-center w-full h-full dark:bg-zinc-800">
                    <Image
                        src="/icons/stack/tailwind-icon.png"
                        alt="tailwind-icon"
                        width={0}
                        height={0}
                        sizes="100vw"
                ...
                <div className="shadow-md p-4 rounded-md flex flex-wrap justify-center items-center w-full h-full dark:bg-zinc-800">
                    <Image
                        src="/icons/stack/docker-icon.png"
                        alt="docker-icon"
                        width={0}
                        height={0}
                        sizes="100vw"
                ...
                <div className="shadow-md p-4 rounded-md flex flex-wrap justify-center items-center w-full h-full dark:bg-zinc-800">
                    <Image
                        src="/icons/stack/vscode-icon.png"
                        alt="vscode-icon"
                        width={0}
                        height={0}
                        sizes="100vw"
                ...
                <div className="shadow-md p-4 rounded-md flex flex-wrap justify-center items-center w-full h-full dark:bg-zinc-800">
                    <Image
                        src="/icons/stack/nestjs-icon.png"
                        alt="nestjs-icon"
                        width={0}
                        height={0}
                        sizes="100vw"
                ...
                <div className="shadow-md p-4 rounded-md flex flex-wrap justify-center items-center w-full h-full dark:bg-zinc-800">
                    <Image
                        src="/icons/stack/laravel-icon.png"
                        alt="laravel-icon"
                        width={0}
                        height={0}
                        sizes="100vw"
                ...
                <div className="shadow-md p-4 rounded-md flex flex-wrap justify-center items-center w-full h-full dark:bg-zinc-800">
                    <Image
                        src="/icons/stack/mysql-icon.png"
                        alt="mysql-icon"
                        width={0}
                        height={0}
                        sizes="100vw"
